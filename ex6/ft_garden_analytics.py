class GardenManager:
    ...
    class GardenStats:
        ...
        def count_score(self, garden):
            ...
            return total_height + prize_total * 4
    ...
    def add_garden(self, garden):
        self.manager_gardens = self.manager_gardens + [garden]
...
if __name__ == "__main__":
    ...
    oak.set_height(100)
    oak.set_age(1800)
    rose = FloweringPlant("Rose", "red")
    rose.set_height(25)
    rose.set_age(20)
    sunflower = PrizeFlower("Sunflower", "yellow")
    sunflower.set_height(50)
    sunflower.set_age(25)
    sunflower.set_points(10)
    ...
    print(f"\nPlants added: {final_plants - initial_plants},"
